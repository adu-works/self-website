...
原型 v2.4.0 已按“个人影响力 + 售卖入口”重新设计，待评审；文档 v3.4 同步调整，正式开发未开始。
...
原型只有 `prototype/` 一份。默认直接进入主站；火星已退出主站展示与首版范围，旧实验地址仍保留。文章、商品、AI 和订单为示例，不收集真实 Key 或付款资料。历史版本和旧方案在 Git 历史中，不保留重复目录。
